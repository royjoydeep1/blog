...
import test.conference.TestApp;
import test.conference.domain.Authority;
import test.conference.domain.User;
import test.conference.repository.AuthorityRepository;
...
import test.conference.web.rest.errors.ExceptionTranslator;
import test.conference.web.rest.vm.KeyAndPasswordVM;
import test.conference.web.rest.vm.ManagedUserVM;
