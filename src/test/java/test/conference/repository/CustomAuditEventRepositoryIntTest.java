package test.conference.repository;

import test.conference.TestApp;
import test.conference.config.Constants;
import test.conference.config.audit.AuditEventConverter;
import test.conference.domain.PersistentAuditEvent;
...
import static test.conference.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
